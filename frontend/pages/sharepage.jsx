  ...
  return (
    <>
      <div className="relative bg-[#121212] min-h-[80vh] w-full flex flex-col items-center justify-center gap-6 sm:gap-8 px-4 sm:px-8 text-center overflow-hidden ">
        ...
        <div className="h-40 w-7/12 flex flex-col justify-center border border-dashed border-gray-600 rounded-xl">
          <p className="text-[#969696]">Drag &amp; drop a file here or</p>
          <input type="file" className="hidden" id="fileInput" />
          <label
            htmlFor="fileInput"
            className="underline cursor-pointer text-amber-50"
          >
            Choose a file
          </label>
        </div>
